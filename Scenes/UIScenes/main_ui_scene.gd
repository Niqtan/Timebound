...
func update_happiness_bar():
	...
	if happiness_bar.frames == null:
		print("no sprite frames!")
	
	var max_frames = happiness_bar.frames.get_frame_count("full_default") - 1
...
func update_skill_bar():
	...
	var max_frames = skill_bar.frames.get_frame_count("full_default") - 1
...
func update_energy_bar():
	...
	var max_frames = energy_bar.frames.get_frame_count("full_default") - 1
